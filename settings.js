...
Drupal.settings.site_path = 'http://localhost/drupal7/refscripts/web'; // e.g. http://www.example.com
...
// App Front Page
drupalgap.settings.front = 'search';

// Theme
drupalgap.settings.theme = 'simpletheme';

// Logo
drupalgap.settings.logo = 'themes/simpletheme/images/drupalgap.jpg';
...
drupalgap.settings.blocks.simpletheme = {
  ...
  content: {
    ...
    main: { },
     search: {
      pages: {
        value: ['articles','ebisoko' ,'proverbs','counties','search'],
        mode: 'include'
      }
    },
  },
